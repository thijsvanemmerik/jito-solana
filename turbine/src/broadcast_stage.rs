...
pub fn broadcast_shreds(
    ...
    // reachable via a different interface than --bind-address. Keep them separate so the UDP
    // path can use the dedicated 0.0.0.0:0 socket, while the XDP path can route them directly.
